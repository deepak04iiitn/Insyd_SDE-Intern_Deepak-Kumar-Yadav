...
export default function ExpiringSoonTable({ stocks, loading, activeTab, pagination, onPageChange, onFormatDate, onFormatQuantityType }) {
        ...
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="divide-y divide-gray-200 bg-white">
            {stocks.map((stock) => {
              ...
              const expiryDateClass = isExpired ? "text-red-600 font-semibold" : "text-orange-600 font-semibold";

              return (
                <tr key={stock._id} className={isExpired ? "bg-red-50" : ""}>
                  ...
                  <td className={`whitespace-nowrap px-6 py-4 text-sm ${expiryDateClass}`}>
                  ...
                  {activeTab === "expired" && (
                    <td className="whitespace-nowrap px-6 py-4 text-sm text-red-600">
                      {onFormatDate(stock.dateExpired)}
                    </td>
                  )}
...
function Pagination({ pagination, onPageChange, isExpired }) {
