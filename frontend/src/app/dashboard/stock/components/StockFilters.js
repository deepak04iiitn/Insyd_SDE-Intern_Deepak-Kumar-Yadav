...
export default function StockFilters({ filters, onFilterChange, isOutOfStock = false }) {
    ...
    <div className="mb-6 rounded-lg bg-white p-4 shadow">
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-6">
        ...
        >
          ...
          {isOutOfStock && (
            <>
              <option value="dateOutOfStock-asc">Out of Stock (Old-New)</option>
              <option value="dateOutOfStock-desc">Out of Stock (New-Old)</option>
            </>
          )}
        </select>
