        ...
        <div className="flex h-16 items-center justify-between">
          ...
          {isAuthenticated ? (
            <div className="flex items-center space-x-4">
              ...
              <button
                onClick={logout}
                className="cursor-pointer rounded-md bg-red-600 px-4 py-2 text-sm font-semibold text-white hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600 transition-colors"
              >
                Logout
              </button>
